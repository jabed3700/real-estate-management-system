...
move_uploaded_file($_FILES["img1"]["tmp_name"],"img/housesimages/".$_FILES["img1"]["name"]);
move_uploaded_file($_FILES["img2"]["tmp_name"],"img/housesimages/".$_FILES["img2"]["name"]);
...
$sql="INSERT INTO tblhouses(houseowner_id,HousesTitle,dds,Himage1,Himage2,Himage3,Himage4,Bed,Bath,size,loc,area,lon,lat,HouseCategory,PricePerMonth,PostingDate,approve,contact) VALUES(:hidden,:housestitle,:de,:himage1,:himage2,:himage3,:himage4,:bed,:bath,:size,:lo,:area,:lon,:lat,:housecategory,:pricepermonth,:bookingdate,:approve,:contact)";
...
if($lastInsertId)
{
$msg="Houses posted successfully";
header('location:post-ahouse.php');
}
else 
{
