...
<head>
    ...
    <title>Hur realestate | Admin Dashboard</title>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-success text-light">
                                                <div class="stat-panel text-center">
                                                    ...
                                                    <?php 
$sql1 ="SELECT id from guest_user ";
...
?>
                                                    ...
                                                    <div class="stat-panel-title text-uppercase">Guest user property list</div>
                                                </div>
                                            </div>
                                            <a href="guestuser.php" class="block-anchor panel-footer text-center">Full
...
?>
                                            ...
                                            <a href="reg-post.php" class="block-anchor panel-footer text-center">Full
                                                Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-info text-light">
                                                <div class="stat-panel text-center">
                                                    ...
                                                    <?php 
$sql2 ="SELECT id from tblhouses where houseowner_id=1";
$query2= $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$bookings=$query2->rowCount();
?>
                                                    ...
                                                    <div class="stat-panel-number h1 ">
                                                        <?php echo htmlentities($bookings);?></div>
                                                    <div class="stat-panel-title text-uppercase">Admin post houses list</div>
                                                </div>
                                            </div>
