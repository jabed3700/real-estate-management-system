...
<html lang="en">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	         ...
	         <!-- <li class="nav-item"><a href="agents.php" class="nav-link">Agents</a></li> -->
	          ...
	          <li class="nav-item cta"><a href="admin" class="nav-link ml-lg-2"><span class="icon-user"></span> Sign-In</a></li>
	          <li class="nav-item cta"><a href="#signupform"  data-toggle="modal" class="nav-link ml-lg-2"><span class="icon-user"></span>  House Info</a></li>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBPGdIDoEVgsND6IF5NeKDoshyPb9hu6vY&sensor=false"></script>
