...
<!-- <section class="ftco-section ftco-degree-bg" style="padding-left: 340px;> 
      <div class="container"> 
        <div class="row"> </div> </section>
          ...
          <div style="padding-left: 260px; padding-top: 50px; padding-right: 200px">  <h2 class="mb-3"># A Renter's Guide to Gift Giving in an Apartment</h2> <p></p>
            <p>Do you have all of your holiday shopping done? The majority of us can’t get everything done on Black Friday or during Cyber Week, so I’ll assume it’s safe to say you still have some items to check off of your list. Don’t worry—I’m right there with you. </p>
            <p> </div>

              <img src="images//blog/b1.jpg" alt="" class="img-fluid" style="padding-left: 260px; padding-top: 30px;padding-bottom: 30px">
            </p>

          <div style="padding-left: 260px; padding-top: 50px; padding-right: 200px">

             <p>Now that you’ve bought (or at least thought of) gifts for your family members, significant other, and close friends, it’s time to consider the other important people in your life: the people who keep your community organized and running, fix your leaky sink, deliver your mail, and deal with the noise of your barking dog, crying baby, or late night get-togethers.

<p> Those people would be no other than the members of your apartment community! This group includes your property manager or landlord, leasing agents, mail carriers, maintenance workers, and neighbors. It's both appropriate and thoughtful to give gifts to those who live in or work for your apartment community. After all, it’s time to spread some holiday cheer! </p>
...
If you’re a renter considering holiday gift giving in your apartment community, pay attention to these suggestions—a gift-giving guide, if you will—for properly giving holiday gifts around your complex this year and every year to come.
            ...
            <h2 class="mb-3 mt-5">#IF YOU WANT TO BE SELECTIVE, BE SELECTIVE.</h2>

            <p>You may not have a desire or feel the need to gift numerous individuals in your apartment community. We understand! Gifting is expensive, especially during the holiday season when you’re buying for a lot of people at once.</p>
            <p>
              <img src="images/blog/b.jpg" alt="" class="img-fluid">
            </p>
            <p>If you only want to give a gift to your property manager or landlord who helped you land a unit in your awesome apartment community, or to your neighbor across the hall that you know best, go for it! Any gift is a nice gesture. Don’t feel like you’re leaving people out. No one expects you to buy a gift for everyone—avoid going overboard! Gift how you want, how much you want, and to whom you want.</p>

             <h4 class="mb-3 mt-5">CONSIDER GIVING WORK-RELEVANT GIFTS.</h4>
          ...
          <h2 class="mb-3 mt-5">What would be a work-relevant gift?</h2>

            <p>
            It’s always nice to give each person a small gift, and even better, a gift that’s relevant to the work they do for the apartment community. For instance, if you’re gifting the doorman, maintenance worker, or mail carrier, a nice pair of gloves, warm hat, or scarf is appropriate since they are often working outdoors.
          </p>

            <p>
            If you’re gifting a property manager or leasing agent, consider a personalized name tag for their desk, office décor, or a coffee mug to keep at their desk! Regardless of what you decide to gift, remember that fresh baked goods go a long way if you’re working on a small budget or gifting a lot of people at once!
          </p>

          <h4 class="mb-3 mt-5">REMEMBER—IT’S NOT MANDATORY.</h4>
          <p>
            Don’t feel like you need to give everyone you know in your apartment community a holiday gift. Whether you’re on a budget, extremely busy, not particularly fond of your neighbors or leasing office staff, or you just don’t want to put thought into that many gifts (I don’t blame you there), there’s no shame in ignoring the gift-giving game!
          </p>

          <h4 class="mb-3 mt-5">AVOID OVER-GIFTING.</h4>
          <p>
           ...
           <h4 class="mb-3 mt-5">Can you ignore gift giving?</h4>
          <p>
          It’s simply a thoughtful gesture. It doesn’t have to be anything big by any means. But, if you’d rather avoid this cheerful tradition all in all—feel free to do so. It’ll save you some time, money, and energy this holiday season. And if this is a priority for you, may I suggest watching Christmas with the Kranks when you get a chance? It’s okay to take a year off from the spending that comes with the holidays—just avoid falling into a Grinch-like attitude. After all, the holidays are about more than just giving gifts!
          </p> 
           </div>
        ...
        <div class="container">
            ...
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text mt-3 d-block">
                <h3 class="heading mt-3"><a href=>A Renter's Guide to Gift Giving in an Apartment</a></h3>
                <div class="meta mb-3">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('images/blog/b8.jpg');">
              </a>
              <div class="text mt-3">
                <h3 class="heading mt-3"><a href="#">Apartment Safety Questions to Ask Before Signing a Lease</a></h3>
                <div class="meta mb-3">
                  <div><a href="#">Dec 6, 2018</a></div>
                  <div><a href="#">Admin</a></div>
                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('images/blog/b9.jpg');">
              </a>
              <div class="text mt-3">
                <h3 class="heading mt-3"><a href="#">Apartment Safety Questions to Ask Before Signing a Lease</a></h3>
                <div class="meta mb-3">
...
<div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('images/blog/b10.jpg');">
              </a>
              <div class="text mt-3">
                <h3 class="heading mt-3"><a href="#">Apartment Safety Questions to Ask Before Signing a Lease</a></h3>
                <div class="meta mb-3">
    ...
    <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('images/blog/b11.jpg');">
              </a>
              <div class="text mt-3">
                <h3 class="heading mt-3"><a href="#">Apartment Safety Questions to Ask Before Signing a Lease</a></h3>
                <div class="meta mb-3">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('images/blog/b12.jpg');">
              </a>
              <div class="text mt-3">
                <h3 class="heading mt-3"><a href="#">Apartment Safety Questions to Ask Before Signing a Lease</a></h3>
                <div class="meta mb-3">
